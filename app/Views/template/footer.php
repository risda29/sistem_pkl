...
<script src="<?= base_url('backend') ?>/assets/js/plugin/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js">
</script>
<!-- Moment JS -->
<script src="<?= base_url('backend') ?>/assets/js/plugin/moment/moment.min.js"></script>
<!-- DateTimePicker -->
<script src="<?= base_url('backend') ?>/assets/js/plugin/datepicker/bootstrap-datetimepicker.min.js">
</script>
<!-- jQuery Scrollbar -->
<script src="<?= base_url('backend') ?>/assets/js/plugin/jquery-scrollbar/jquery.scrollbar.min.js">
</script>
<!-- Azzara JS -->
...
<!-- Bootstrap Toggle -->
<script src="<?= base_url('backend') ?>/assets/js/plugin/bootstrap-toggle/bootstrap-toggle.min.js">
</script>
<!-- Script deklarasi data table -->
<script>
    new DataTable('#add-row');
</script>
<!-- <script src="https://code.jquery.com/jquery-3.7.0.js"></script> -->
