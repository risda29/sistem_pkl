					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<h4 class="card-title">Modul Kelas Data</h4>
									...
									<div class="modal-content">
										<div class="modal-header">
											<h5 class="modal-title">
												<span class="fw-mediumbold">Tambah Kelas Data</span>
											</h5>
										...
										<div class="modal-body">
											<form method="POST" action="<?= base_url('Kelas/proses_tambah_kelas') ?>"
													...
													<td>
														<div class="btn-group" role="group" aria-label="Basic example">
															<a href="#" class="btn btn-primary btn-sm edit-kelas"
																data-toggle="modal"
																data-target="#modalEdit<?= $item['id_kelas']; ?>" title="Edit">
						...
						<!-- modal edit -->
						<?php foreach ($kelas as $key => $item): ?>
							<div class="modal fade" id="modalEdit<?= $item['id_kelas']; ?>" tabindex="-1" role="dialog"
								aria-labelledby="modalEditLabel" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header no-bd">
											<h5 class="modal-title">
												<span class="fw-mediumbold">Edit Kelas Data</span>
											</h5>
											<button type="button" class="close" data-dismiss="modal" aria-label="Close">
												<span aria-hidden="true">&times;</span>
											</button>
										...
										<div class="modal-body">
											<form method="POST"
												action="<?= base_url('Kelas/update_kelas/' . $item['id_kelas']); ?>"
												enctype="multipart/form-data">
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<a href="<?= base_url('kelas/hapus_kelas/' . $item['id_kelas']); ?>"
